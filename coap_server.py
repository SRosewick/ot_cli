...
class HelloTestResource(resource.Resource):
    """
    Resource that handles PUT requests for the /hello_test endpoint.
...
async def main():
    ...
    hello_test_resource = HelloTestResource()
    root.add_resource(["hello_test"], hello_test_resource)
